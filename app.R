    ...
    tabPanel(title = HTML(paste(p(strong("Author Profiler"),style = "font-size:18px"))),
             sidebarLayout(
               sidebarPanel(width = 2,
                            ...
                            hr(),
                            tags$p(strong("Author Name/ID format:"), HTML(paste("<br/>fauci as [au]","or fauci, anthony [au]","or orcid xxxx-xxxx-xxxx-xxxx [auid]",sep = "<br/>"))),
                            br(),
                            tags$p('Click here to download detailed supporting information'),
